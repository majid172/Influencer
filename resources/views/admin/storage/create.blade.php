								...
								<div class="col-lg-12">
									<div class="card mb-4 card-primary shadow">
										<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
											<h6 class="m-0 font-weight-bold text-primary">@lang('Add New Language')</h6>
												...
												<div class="row">
														...
														<div class="form-group">
															...
															<select name="short_name"
																...
																@foreach(config('languages.langCode') as $key => $value)
																	<option value="{{$key}}" {{  (old('short_name') == $key ? ' selected' : '') }}>{{ __($key).' - '.__($value) }}</option>
																@endforeach
															</select>
															<div class="invalid-feedback">@error('short_name') @lang($message)@enderror
															</div>
														</div>
													</div>
													<div class="col-md-6">
															...
															<div class="selectgroup w-100">
																<label class="selectgroup-item">
																	<input type="radio" name="rtl" value="0"
																		   class="selectgroup-input" {{ old('rtl') == 0 ? 'checked' : ''}}>
																	<span class="selectgroup-button">@lang('OFF')</span>
																</label>
																<label class="selectgroup-item">
																	<input type="radio" name="rtl" value="1"
																		   class="selectgroup-input" {{ old('rtl') == 1 ? 'checked' : ''}}>
																	<span class="selectgroup-button">@lang('ON')</span>
																</label>
															</div>
															@error('rtl')
													...
													<div class="col-md-6">
														<div class="form-group mb-4">
															<label class="col-form-label">@lang('Choose Flag')</label>
															<div id="image-preview" class="image-preview">
																<label for="image-upload" id="image-label">@lang('Choose Flag')</label>
																<input type="file" name="flag" class=" @error('flag') is-invalid @enderror" id="image-upload"/>
															</div>
