		...
		<section class="section">
			<div class="section-header">
				...
				<div class="section-header-breadcrumb">
					...
					<div class="breadcrumb-item">@lang("Create City")</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12 col-md-12 col-lg-12">
						<div class="card mb-4 card-primary shadow-sm">
							...
							<div class="card-body">
								<form method="post" action="{{ route('admin.cityStore') }}" class="mt-4" enctype="multipart/form-data">
									@csrf
									<div class="row">
