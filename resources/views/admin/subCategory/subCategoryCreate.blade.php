	...
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang("Create Sub-Category")</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active"><a href="{{ route('admin.home') }}">@lang("Dashboard")</a></div>
					<div class="breadcrumb-item"><a href="{{route('admin.subCategory.index')}}">@lang("Sub-Category List")</a>
					</div>
					<div class="breadcrumb-item">@lang("Create Sub-Category")</div>
				</div>
			</div>
		</section>
				...
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card mb-4 card-primary shadow-sm">
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
							<h5>@lang("Create Sub-Category")</h5>
						...
						<div class="card-body">
							...
							<div class="tab-content mt-2" id="myTabContent">
								...
								<div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
									role="tabpanel">
									<form method="post" action="{{ route('admin.subCategory.store', $language->id) }}"
										...
										<div class="row mb-3">
											<div class="col-sm-12 col-md-12 mb-3">
												...
												<select name="category_id"
													...
													<option value="{{ optional($item->details)->category_id }}">
