					...
					<div class="container-fluid" id="container-wrapper">
						<div class="card mb-4 card-primary shadow">
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">@lang('List of all templates - push notify')</h6>
							</div>
							<div class="card-body">
										...
										@foreach($notifyTemplates as $template)
											<tr>
												...
												<td data-label="@lang('Action')">
													<a href="{{ route('push.notify.template.edit',$template->id) }}" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i> @lang('Edit') </a>
												</td>
											</tr>
										@endforeach
										</tbody>
