									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="password" name="currentPassword" value="{{ old('currentPassword') }}" placeholder="@lang('Enter your current password')"
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="password" name="password_confirmation" value="{{ old('password_confirmation') }}"
													   class="form-control form-control-sm" placeholder="@lang('Repeat password')">
											</div>
										</div>
										<div class="col-md-12">
