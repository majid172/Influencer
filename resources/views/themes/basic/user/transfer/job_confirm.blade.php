...
@section('title',__('Wallet Transfer Confirm'))
					...
					<div class="col-lg-12">
						<div class="card mb-4 shadow card-primary">
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-center">
								<h6 class="m-0 font-weight-bold text-primary">@lang('Wallet Transfer For Job')</h6>
							</div>
							<div class="card-body">

								<form action="{{ route('transfer.confirm.job.payment',$utr) }}" method="post">
									@csrf
									<ul class="list-group">
