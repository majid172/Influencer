					...
					<div class="col-md-6">
						<div class="card shadow card-primary mb-4">
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">@lang('Send Money')  {{basicControl()->base_currency}}</h6>
							</div>
							<div class="card-body">
								<form action="{{ route('transfer.initialize.listing') }}" method="post">
									@csrf
									<div class="form-group">
										<input type="hidden" name="escrow_id" value="" class="escrow_id">
									</div>
