						...
						<div class="messages-box">
							<div
								...
								<div
									...
									<i title="Away" aria-hidden="true"
									   class="online position-absolute fa fa-circle font-12"
									   :class="(contact.last_seen == false) ? 'text-warning' : 'text-success'"></i>
								</div>
						...
						<div class="inbox-wrapper">
							...
							<div class="chats d-flex justify-content-center align-items-center"
								...
								<div class="text-center">
									<img class="mb-3 no-data-img" src="{{asset($themeTrue.'images/no-data.png')}}" alt="no_data">
									<p class="chat-box font14">
